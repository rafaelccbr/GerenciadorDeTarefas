        ...
        <form onSubmit={handleSubmit} className="w-full flex flex-col items-center space-y-5">
          ...
          <div className="w-full flex flex-col items-center">
            ...
            <input
              ...
              className={`w-full max-w-sm px-6 py-3.5 rounded-full text-center focus:outline-none transition-all font-medium border shadow-md ${
                ehDark
          ...
          {/* Botão Entrar em Cristal Translúcido com Acento Neon */}
          <div className="pt-3 w-full flex justify-center">
            <button
              type="submit"
              disabled={carregando}
              className={`px-14 py-3.5 active:scale-95 text-white text-lg font-semibold rounded-full backdrop-blur-md transition-all duration-300 cursor-pointer disabled:opacity-50 ${
                ehDark
